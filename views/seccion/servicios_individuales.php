<section class="contenedor_servicio_individual" >
    ...
    <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    ...
                    <div class="col-md-12" id="slider">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" id="carousel-bounding-box">
                                <ul class="breadcrumb">
                                    <li style="text-transform: uppercase;"><a href="index?pagina=servicios"><font color="white">Servicios</font></a></li>

                                    <li style="text-transform: uppercase;"><a href="index?pagina=servicios&grupo_servicios_id= <?php echo $grupo_servicio_id; ?>"><font color="white"><?php echo $nombre_grupo; ?></font></a></li>
        ...
        <div class="contenedor">
                <div class="col-xs-12 col-md-10 col-md-offset-1 descripcion_serv_ind">
                    <div id="id_subgrupo_oculto" style="display: none">
                        ...
                        <strong>Descripción:</strong><br><p><?php echo $descripcion_res; ?></p>
                    <br>
        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2" style="text-align: center;  min-height: 200px;">
            ...
            <p style="text-align: left; padding: 20px 40px;"><?php
        ...
        <section class="seccion_2_servicios_individual">
            ...
            ==================================  -->
                <div class="col-xs-12 col-md-12" style="padding-bottom: 40px;">
                    ...
                    <center><h3>SERVICIOS RELACIONADOS</h3></center>
                    </div>
                        ...
                        <div class="container-fluid cont_caja_servicios">
                            ...
                            <div class="flex-container table-responsive-sm" id="accordion2">
                                ...
                                <div class="col-sm-12 col-md-12 nombre">
                                    ...
                                    <h4><a href="index?pagina=servicio_individual&servicio_id=<?php echo $id_servicio; ?>&grupo_servicio_id=<?php echo $subgrupo_servicios_id; ?>"><font color="#4D0000"><?php echo $nombre; ?></font></a></h4>
                                </div>
