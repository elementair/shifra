				...
				<div class="col-md-12">
					...
					<div class="form-group">
			        	...
			        	<div class="form-group">
				            	...
				            	<option value="aleatorio">Dejar que el sistema lo eliga por mi</option>
				            	<option value="eleccion">Escoger a mi terapeuta</option>
				        	</select>
			        	</div>
			...
			<div class="tab"><h3><span>6</span>RESUMEN:</h3>
				...
				<div class="col-md-12">
					<ul class="nav nav-tabs opciones">
						...
						<li style="width: 50%;">
							<a data-toggle="tab" href="#tarjeta">TARJETA</a>
						</li>
					</ul>
					<div class="tab-content">
				  	...
				  	<div class="form-group">
							...
							<div class="radio-inline checMoney">
								<label class="container" for="oxxo">
									<input type="radio" name="opcion_pago" value="oxxo" id="oxxo" >
									<span class="checkmark"></span>
								</label>
							<br>
